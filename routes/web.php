...
Route::middleware(['auth', 'verified'])->group(function () {
    Route::get('dashboard', DashboardController::class)->middleware('direct_permission:manage dashboard')->name('dashboard');

    Route::prefix('department')->name('department.')->middleware('direct_permission:manage departments')->group(function() {
    ...
    Route::prefix('user')->name('user.')->middleware('direct_permission:manage users')->group(function() {
    ...
    Route::prefix('task')->name('task.')->middleware('direct_permission:manage tasks')->group(function() {
    ...
    Route::prefix('task-preset')->name('taskPreset.')->middleware('direct_permission:manage task presets')->group(function() {
    ...
    Route::prefix('transaction')
        ->name('transaction.')
        ->middleware('direct_permission:manage transactions')
        ->group(function () {
